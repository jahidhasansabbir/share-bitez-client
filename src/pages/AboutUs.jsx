    ...
    <section className="min-h-screen">
      <div className=" text-center">
        ...
        <p className="text-lg text-gray-700 mb-12">
          Share Bit is a community-driven platform dedicated to reducing food waste and fighting hunger. Our mission is
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
          <div className="bg-white rounded-2xl shadow-sm p-8   transition-shadow duration-300">
            ...
            <p className="text-gray-700">
              Share Bit started with a simple idea: what if we could bridge the gap between abundance and need? From our
          ...
          <div className="bg-white rounded-2xl shadow-sm p-8   transition-shadow duration-300">
            ...
            <p className="text-gray-700">
              ...
              Bit is building the technology and community to make this vision a reality.
            </p>
          </div>

          <div className="bg-white rounded-2xl shadow-sm p-8   transition-shadow duration-300">
            <h3 className="text-2xl font-semibold text-blue-600 mb-4">Why Choose Share Bit?</h3>
        ...
        <div className="mt-16">
          ...
          <p className="text-lg text-gray-700 mb-6">
            Whether you have food to give or need a helping hand, Share Bit is here for you. Be a part of our mission
